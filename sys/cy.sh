...
function start_menu(){
    ...
    blue " 3. SpeedTest-Linux 下载"
    blue " 4. Rclone&Fclone·下载" 
    blue " 5. ChangeSource Linux换源脚本·下载"
    blue " 6. Besttrace 路由追踪·下载"
    blue " 7. NEZHA.SH哪吒面板/探针"
    yellow " --------------------------------------------------"
    green " 11. 获取本机IP"
    ...
    green " 19. F2B一键安装脚本"
    yellow " --------------------------------------------------"
    blue " 21. Superbench 综合测试"
    blue " 22. MT.SH 流媒体解锁测试"
    blue " 23. Lemonbench 综合测试"
    blue " 24. UNIXbench 综合测试"
    blue " 25. 三网Speedtest测速"
    blue " 26. Memorytest 内存压力测试"
    blue " 27. Route-trace 路由追踪测试"
    blue " 28. YABS LINUX综合测试"
    blue " 29. Disk Test 硬盘&系统综合测试"
    blue " 210.TubeCheck Google/Youtube CDN分配节点测试"
    blue " 211.RegionRestrictionCheck 流媒体解锁测试"
    yellow " --------------------------------------------------"
